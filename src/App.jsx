            ...
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    <div className="card shadow">
                        <div className="card heaader bg-primary text-white">
                            <h3 className="card-title">Simulador de Crédito</h3>
                        </div>
                        ...
                        {resultado && (
                            <div className={`alert alert-success mt-3`}>
                                ...
                                <p className= "mb-1" ><strong>Cuota Mensual:</strong> ${resultado.cuotaMensual.toFixed(2)}</p>
                                <p className= "mb-1" ><strong>Interés Total:</strong> ${resultado.interesTotal.toFixed(2)}</p>
                                <p className= "mb-1" ><strong>Monto Total a Pagar:</strong> ${resultado.montoTotal.toFixed(2)}</p>
                            </div>
                        )}
                    </div>    
                </div>
